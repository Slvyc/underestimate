...
@section('content')
    <section class="hero">
        <div class="container-hero text-center">
            <h1 class="display-4 fw-bold fade-in">Tingkat Kesiapan Teknologi</h1>
    ...
    <section class="download-content py-5">
        <div class="container">
            <!-- Search Box -->
            <form action="{{ route('kesiapanTeknologi') }}" method="GET">
                ...
                <table class="download-table table table-hover" id="sop-download-table">
                    <thead class="download-table-header table-dark">
                        <tr>
                            ...
                            <th class="download-col-name">PRODUK INOVASI TEKNOLOGI</th>
                            <th class="download-col-date">DESKRIPSI</th>
                            <th class="download-col-action">NILAI TKT</th>
                            <th class="download-col-date">TANGGAL</th>
                            <th class="download-col-action">AKSI</th>
                        </tr>
                    </thead>
                    <tbody class="download-table-body">
                        @include('partials.kesiapanTeknologi-table')
                    </tbody>
                </table>
            </div>
        </div>
