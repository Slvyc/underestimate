...
@section('content')
    <section class="hero">
        <div class="container-hero text-center">
            <h1 class="display-4 fw-bold fade-in">Survey Kepuasan</h1>
                ...
                <table class="download-table table table-hover" id="sop-download-table">
                    <thead class="download-table-header table-dark">
                        <tr>
                            ...
                            <th class="download-col-name">Jenis Survey</th>
                            <th class="download-col-link">Aksi</th>
                        </tr>
                    </thead>
                    <tbody class="download-table-body">
                        @include('partials.survey-table')
                    </tbody>
                </table>
            </div>
        </div>
