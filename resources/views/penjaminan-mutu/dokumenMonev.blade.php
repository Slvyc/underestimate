...
@section('content')
    <section class="hero">
        <div class="container-hero text-center">
            <h1 class="display-4 fw-bold fade-in">Dokumen Monev</h1>
    ...
    <section class="download-content py-5">
        <div class="container">
            <!-- Search Box -->
            <form action="{{ route('dokumenMonev') }}" method="GET">
                ...
                <table class="download-table table table-hover" id="sop-download-table">
                    <thead class="download-table-header table-dark">
                        <tr>
                            ...
                            <th class="download-col-name">Nama Dokumen</th>
                            <th class="download-col-name">Aksi</th>
                        </tr>
                    </thead>
                    <tbody class="download-table-body">
                        @include('partials.dokumenMonev-table')
                    </tbody>
                </table>
            </div>
        </div>
