...
use App\Filament\Resources\DosenMesinResource\Pages;
use App\Filament\Resources\DosenMesinResource\RelationManagers;
...
class DosenMesinResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Dosen Teknik Mesin'; // Mengubah nama sidebar
    protected static ?string $label = 'Dosen Teknik Mesin '; // Mengubah nama header
    protected static ?string $slug = 'Dosen-Mesin'; // Mengubah nama slug di url
    ...
    {
        return [
            'index' => Pages\ManageDosenMesins::route('/'),
        ];
    }
}
