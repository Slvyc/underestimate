...
use App\Filament\Resources\DosenSiResource\Pages;
use App\Filament\Resources\DosenSiResource\RelationManagers;
...
class DosenSiResource extends Resource
{
    protected static ?string $model = DosenSi::class;
    protected static ?string $navigationGroup = 'Dosen';
    protected static ?string $navigationLabel = 'Dosen Sistem Informasi'; // Mengubah nama sidebar
    protected static ?string $label = 'Dosen Sistem Informasi '; // Mengubah nama header
    protected static ?string $slug = 'Dosen-Si'; // Mengubah nama slug di url
    ...
    {
        return [
            'index' => Pages\ManageDosenSis::route('/'),
        ];
    }
}
