...
class DokumenAmiResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Dokumen Ami'; // Mengubah nama sidebar
    protected static ?string $label = 'Dokumen'; // Mengubah nama header
    protected static ?string $slug = 'Dokumen-Ami'; // Mengubah nama slug di url
    ...
    {
        return [
            'index' => Pages\ManageDokumenAmis::route('/'),
        ];
    }
}
